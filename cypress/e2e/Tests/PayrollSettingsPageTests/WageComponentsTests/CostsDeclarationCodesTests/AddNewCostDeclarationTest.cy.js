...
import AddNewCostDeclaration from '../../../../Pages/PayrollSettingsPage/WageComponentsPage/CostsDeclarationCodesPage/AddNewCostDeclaration.js'
...
describe('Add new cost declaration form Test', () => {
  beforeEach(() => {
    cy.visit('/');
    ...
    SideMenu.openPayrollSettingsSection();
      ...
      it('should can go to componets check if can add one new cost delaration', () => {
        ...
        AddNewCostDeclaration.openAddNewCostDeclaratioForm();
        AddNewCostDeclaration.cancelAddNewCostDeclaratioForm();
      });
